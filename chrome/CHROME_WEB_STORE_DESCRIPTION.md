...
- Calculates cash flow including:
  - Mortgage payments (with customizable down payment and interest rates)
  - Property taxes (auto-fetched by ZIP code or manually overridden)
...
- Quickly identify cash-flow positive properties without manual calculations
...
2. Browse any supported real estate site (Zillow, Redfin, etc.)
3. Look for the "fmr.fyi" badge next to property addresses
4. Click the badge to see detailed analysis
5. Customize your financial parameters in the extension popup (click the extension icon)

### 📊 Data Sources

- **Fair Market Rent (FMR)**: Official HUD data updated annually
- **Small Area FMR (SAFMR)**: ZIP code-level FMR data for select metropolitan areas
- **Market Parameters**: Property tax rates and mortgage rates by ZIP code

### 💬 Support

For questions, feedback, or issues, visit [fmr.fyi](https://fmr.fyi) or check the extension's settings page.

---

**Make smarter real estate decisions with instant cash flow analysis. Install fmr.fyi today and transform how you evaluate rental properties.**
