...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = `View property values (ZHVI), tax rates, and Investment Scores for all ZIP codes. Compare FMR to property values, analyze rent-to-price ratios, and evaluate Section 8 investment potential.`;
