...
export const metadata: Metadata = {
  title: 'Privacy Policy | fmr.fyi',
  description: 'Privacy Policy for fmr.fyi - Learn how we collect, use, and protect your personal information.',
  alternates: { canonical: 'https://fmr.fyi/privacy' },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-[var(--bg-primary)] antialiased">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
          ...
          <div className="privacy-page mt-8" data-custom-class="body">
            <span
              style={{
                display: 'block',
            ...
            <ul>
              <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
                <span style={{ fontSize: '15px' }}>
                  Use <strong>fmr.fyi – Fair Market Rent Research Helper</strong>. fmr.fyi is a real estate research
                  tool that helps users analyze investment properties by displaying Fair Market Rent (FMR) data and cash
                  flow calculations directly on real estate listing websites like Zillow and Redfin. The service
                  provides market data including rental rates, property tax rates, mortgage rates, and investment scores
                  to help users make informed real estate investment decisions. Users can browse properties on their
                  preferred real estate websites and see relevant market data overlaid on listings without leaving the
                  page.
                </span>
              </li>
            </ul>
            ...
            <div style={{ lineHeight: 1.5 }}>
              <span style={{ fontSize: '15px' }}>
                <span data-custom-class="body_text">
                  ...
                  applicable privacy law may mean you have certain rights regarding your personal information. Learn more
                  about{' '}
                </span>
              </span>
              ...
              <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    ...
                    IP address, device information, browser type, and settings and information about your activity in the
                ...
                <span data-custom-class="body_text">
                  <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                    <span data-custom-class="body_text">
                      ...
                      <em>
                        We may collect limited data from public databases, marketing partners, social media platforms,
              ...
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  <span data-custom-class="body_text">
                    ...
                    databases, joint marketing partners, affiliate programs, data providers, social media platforms, and
                    from other third parties. This information includes mailing addresses, job titles, email addresses,
            ...
            <div style={{ lineHeight: 1.5 }}>
              <span style={{ fontSize: '15px' }}>
                <span data-custom-class="body_text">1125 NW 12TH AVE</span>
              </span>
            </div>
            <div style={{ lineHeight: 1.5 }}>
            ...
            <div style={{ lineHeight: 1.5 }}>
              <span style={{ fontSize: '15px' }}>
                <span data-custom-class="body_text">PORTLAND, OR 97209</span>
              </span>
            </div>
            <div style={{ lineHeight: 1.5 }}>
              <span data-custom-class="body_text" style={{ fontSize: '15px' }}>
            ...
            <div>
              ...
              <a href="https://termly.io/products/privacy-policy-generator/" target="_blank" data-custom-class="link">
