...
export const metadata: Metadata = {
  ...
  description:
    "Browse ZIP codes by state to view HUD Fair Market Rent (FMR/SAFMR) data.",
    ...
    <main className="min-h-screen bg-[#fafafa] antialiased">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <p className="mt-3 text-base text-[#525252]">
          Pick a state to browse ZIP codes. Each ZIP page redirects to the main
          FMR view.
        </p>
        <div className="mt-4">
          <a
            href="/zip-property-data"
            className="inline-block text-sm px-3 py-1.5 rounded-md border border-[#e5e5e5] bg-white hover:bg-[#f5f5f5] text-[#0a0a0a]"
          >
            View all ZIP codes with property values & tax rates →
          </a>
        </div>
